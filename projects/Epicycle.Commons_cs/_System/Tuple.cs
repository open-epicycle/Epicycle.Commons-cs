...
namespace System
{
    ...
    public class Tuple<T1, T2, T3> : IComparable
    {
        ...
        int IComparable.CompareTo(Object obj)
        {
            ...
            if (result == 0)
            {
                ...
                if (result == 0)
                {
                    return ((IComparable)Item3).CompareTo(other.Item3);
                }
    ...
    public class Tuple<T1, T2, T3, T4> : IComparable
    {
        ...
        public override bool Equals(Object obj)
        {
            if (obj == null || !(obj is Tuple<T1, T2, T3, T4>))
            {
                return false;
            }

            var other = (Tuple<T1, T2, T3, T4>)obj;
        ...
        int IComparable.CompareTo(Object obj)
        {
            ...
            if (result == 0)
            {
                ...
                if (result == 0)
                {
                    ...
                    if (result == 0)
                    {
                        return ((IComparable)Item4).CompareTo(other.Item4);
                    }
    ...
    public class Tuple<T1, T2, T3, T4, T5> : IComparable
    {
        ...
        public override bool Equals(Object obj)
        {
            if (obj == null || !(obj is Tuple<T1, T2, T3, T4, T5>))
            {
                return false;
            }

            var other = (Tuple<T1, T2, T3, T4, T5>)obj;
            ...
            if (result == 0)
            {
                ...
                if (result == 0)
                {
                    ...
                    if (result == 0)
                    {
                        ...
                        if (result == 0)
                        {
                            return ((IComparable)Item5).CompareTo(other.Item5);
                        }
    ...
    public class Tuple<T1, T2, T3, T4, T5, T6> : IComparable
    {
        ...
        public override bool Equals(Object obj)
        {
            if (obj == null || !(obj is Tuple<T1, T2, T3, T4, T5, T6>))
            {
                return false;
            }

            var other = (Tuple<T1, T2, T3, T4, T5, T6>)obj;
        ...
        int IComparable.CompareTo(Object obj)
        {
            ...
            if (!(obj is Tuple<T1, T2, T3, T4, T5, T6>))
            {
                throw new ArgumentException(string.Format("obj is of the wrong type: {0}!", obj.GetType()));
            }
                ...
                if (result == 0)
                {
                    ...
                    if (result == 0)
                    {
                        ...
                        if (result == 0)
                        {
                            ...
                            if (result == 0)
                            {
                                return ((IComparable)Item6).CompareTo(other.Item6);
                            }
    ...
    public class Tuple<T1, T2, T3, T4, T5, T6, T7> : IComparable
    {
        ...
        public override bool Equals(Object obj)
        {
            if (obj == null || !(obj is Tuple<T1, T2, T3, T4, T5, T6, T7>))
            {
                return false;
            }

            var other = (Tuple<T1, T2, T3, T4, T5, T6, T7>)obj;
        ...
        int IComparable.CompareTo(Object obj)
        {
            ...
            if (!(obj is Tuple<T1, T2, T3, T4, T5, T6, T7>))
            {
                throw new ArgumentException(string.Format("obj is of the wrong type: {0}!", obj.GetType()));
            }
                    ...
                    if (result == 0)
                    {
                        ...
                        if (result == 0)
                        {
                            ...
                            if (result == 0)
                            {
                                ...
                                if (result == 0)
                                {
                                    return ((IComparable)Item7).CompareTo(other.Item7);
                                }
